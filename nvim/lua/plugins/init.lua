return {
    {
        ...
        opts = {
            formatters_by_ft = {
                ...
                jsonc = { "prettierd", "prettier", lsp_format = "fallback" },
    ...
    {
        dir = "~/code/lua/maven.nvim",
        dependencies = {
            'nvim-telescope/telescope.nvim',
            'nvim-lua/plenary.nvim'
        },
        cond = function()
            local stat = vim.uv.fs_stat(vim.env.HOME .. "/code/lua/maven.nvim")
    ...
    },
    {
        ...
        config = function()
            local my_space = require("my_spaces")
            my_space.setup()
    ...
    {
        "yonchando/http.nvim",
        -- dir = "/home/chando/code/lua/http.nvim",
        config = function()
